...
namespace PhotoshopFile
{
  ...
  public class ResolutionInfo : ImageResource
  {
    ...
    /// <summary>
    /// Units in which to display horizontal resolution.  Whatever units
    /// are used for display, the resolution is still stored internally
    /// as pixels/inch.
    /// </summary>
    public ResUnit HResDisplayUnit { get; set; }

    /// <summary>
    /// Units in which to display vertical resolution.  Whatever units
    /// are used for display, the resolution is still stored internally
    /// as pixels/inch.
    /// </summary>
